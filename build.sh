...
cd jni
c++ halide.cpp -L /home/kiwi/Documents/halide/bin -lHalide -I /home/kiwi/Documents/halide/include -ldl -lpthread -lz
...
#archs=arm-32-android
archs=x86-32-android
IFS=,
set $archs
hl_target=$1
android_abi=$2
...
echo $hl_target
HL_TARGET=$hl_target DYLD_LIBRARY_PATH=/home/kiwi/Documents/halide/bin LD_LIBRARY_PATH=/home/kiwi/Documents/halide/bin ../a.out
cd ..
unset IFS
#done
